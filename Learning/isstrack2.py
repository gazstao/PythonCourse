...
file = open("e:/Google Drive/Programacao/Python/Learning/Data/iss-{}.txt".format(horaExecucao),"w")
issdata = open("e:/Google Drive/Programacao/Python/Learning/Data/iss-{}.csv".format(horaExecucao),"w")
...
screen.bgpic("e:/Google Drive/Programacao/Python/Learning/map2.gif")
screen.register_shape("e:/Google Drive/Programacao/Python/Learning/iss-icon.gif")
iss = turtle.Turtle()
iss.shape("e:/Google Drive/Programacao/Python/Learning/iss-icon.gif")
iss.setheading(45)
iss.penup()
...
def gravaTela():
    ...
    canvas.postscript(file="e:/Google Drive/Programacao/Python/Learning/Data/iss.eps", colormode="color")
    img = Image.open("e:/Google Drive/Programacao/Python/Learning/Data/iss.eps")
    img.save("e:/Google Drive/Programacao/Python/Learning/Data/iss-track-{}.png".format(horaExecucao))

while rodando:
    file = open("e:/Google Drive/Programacao/Python/Learning/Data/iss-{}.txt".format(horaExecucao),"a")
    issdata = open("e:/Google Drive/Programacao/Python/Learning/Data/iss-{}.csv".format(horaExecucao),"a")
    ...
    #grava a cada 5 minutos (300 segundos)
    frame = frame+1
    if frame > 30:
        gravaTela()
